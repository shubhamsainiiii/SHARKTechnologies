    ...
    return (
        <>
                ...
                <div className="container-custom" style={{ position: 'relative', zIndex: 1 }}>
                    ...
                    <div className="sdp-hero-grid">
                        ...
                        <motion.div initial={{ opacity: 0, y: 28 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
                            ...
                            <Link
                                to="/contact"
                                style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '12px 26px', background: `linear-gradient(135deg, ${accent}, ${accent2})`, borderRadius: '11px', color: '#000', textDecoration: 'none', fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '0.875rem' }}
                            >
                                <FiMessageSquare style={{ fontSize: '14px' }} /> Get a Free Quote
                            </Link>
                        </motion.div>
            ...
            {(whatWeDeliver.length > 0 || process.length > 0) && (
                <section className="section-padding" style={{ background: 'var(--bg-secondary)' }}>
                    <div className="container-custom">
                        <div className="sdp-two-col" style={{ marginBottom: techStack.length > 0 ? '32px' : '0' }}>
                            ...
                            {whatWeDeliver.length > 0 && (
                                <motion.div
                                    ...
                                    style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '20px', padding: '28px' }}
                                >
                                    <div style={{ display: 'inline-flex', marginBottom: '18px', padding: '4px 12px', background: `${accent}10`, border: `1px solid ${accent}25`, borderRadius: '6px', color: accent, fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '0.65rem', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
                                        What We Deliver
                                    </div>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
                            ...
                            {process.length > 0 && (
                                <motion.div
                                    ...
                                    style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '20px', padding: '28px' }}
                                >
                                    <div style={{ display: 'inline-flex', marginBottom: '18px', padding: '4px 12px', background: 'rgba(255,107,53,0.1)', border: '1px solid rgba(255,107,53,0.2)', borderRadius: '6px', color: 'var(--accent-warm)', fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '0.65rem', letterSpacing: '0.12em', textTransform: 'uppercase' }}>
                                        Our Process
                                    </div>
                                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0' }}>
                                        {process.map((p, i) => (
                        ...
                        {techStack.length > 0 && (
                            <motion.div
                                ...
                                style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: '20px', padding: '28px' }}
                            >
                                <div style={{ fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '0.72rem', letterSpacing: '0.12em', textTransform: 'uppercase', color: 'var(--text-muted)', marginBottom: '16px' }}>
                                    Tech Stack
                                </div>
                                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '8px' }}>
                                    {techStack.map(t => (
            ...
            <section style={{ padding: '60px 0', background: 'var(--bg-primary)' }}>
                <div className="container-custom">
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '16px' }}>
                        ...
                        <Link
                            to="/services"
                            style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', padding: '11px 24px', background: `linear-gradient(135deg, ${accent}, ${accent2})`, borderRadius: '11px', color: '#000', textDecoration: 'none', fontFamily: 'Syne, sans-serif', fontWeight: '700', fontSize: '0.875rem' }}
                        >
